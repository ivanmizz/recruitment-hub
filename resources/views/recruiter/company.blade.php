        ...
        <tbody>
            @foreach ($companies as $company)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        @if($company->logo)
                            <img src="{{ Storage::url($company->logo) }}" alt="{{ $company->name }}" class="rounded-full object-cover w-12 h-12">
                        @endif
                    </td>
                    <td class="px-6 py-4">{{ $company->name }}</td>
                    <td class="px-6 py-4">{{ $company->category->name }}</td>
                    <td class="px-6 py-4">{{ $company->description }}</td>
                    <td class="px-6 py-4">{{ $company->location }}</td>
                    <td class="px-6 py-4"> 
                        <button class= "text-white bg-green-700 hover:bg-green-800  font-medium rounded text-sm px-2 py-2 text-center dark:bg-green-600 dark:hover:bg-green-700">
                            Edit
                        </button>
                        <button class="text-white bg-rose-700 hover:bg-rose-800  font-medium rounded text-sm px-2 py-2 text-center dark:bg-rose-600 dark:hover:bg-rose-700">
                            Delete
                        </button>
