<x-app-layout>
    ...
    <div class="p-4 sm:ml-64">
        ...
        {{-- POP UP NOTIFICATION IF LISTING UPDATE IS SUCCESSFUL --}}
        @if (session('success'))
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <input type="text" name="role_level" id="role_level"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                required="" value="{{ $listing->role_level }}">
                        </div>
                        <div class="col-span-2 sm:col-span-1">
                            <label for="location"
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <input type="text" name="contract_type" id="contract_type"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                required="" value="{{ $listing->contract_type }}"">
                        </div>
                        ...
                        <div class="relative max-w-sm">
                            ...
                            <input datepicker datepicker-autohide datepicker-format="dd/mm/yyyy" type="text"
                                ...
                                value="{{ $listing->due_date }}" required>
                        </div>
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <input type="text" name="requirement" id="requirement"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                required="" value="{{ $listing->requirement }}">
                        </div>
                    ...
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-4 md:p-5 text-center">
                                ...
                                <form id="deleteForm" action="{{ route('listing.destroy', $listing->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('DELETE')
